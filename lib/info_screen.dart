    ...
    return Scaffold(
      ...
      body: const Center(
        child: Column(
            ...
            children: <Widget>[
              Text('Our application is about an employee’s  salary calculation program. '
        'When you enter in our application, first of all, you register and choose if you are manager or an employee. After you register, the main screen will come up. '
        ...
        'In Print File Generation’ page, the main idea is to see the selected employee’s information. '
        ...
        'In ‘Work Plan’, you can see the employee’s work plan by each one.'
